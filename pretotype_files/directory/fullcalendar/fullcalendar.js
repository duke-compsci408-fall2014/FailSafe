...
fc.datepickerLang = function(langCode, datepickerLangCode, options) {
	...
	mergeOptions(langOptions, {
		...
		defaultButtonText: {
            ...
            alert: stripHtmlEntities(options.alertText)
		}
	});
...
function Calendar(element, instanceOptions) {
	...
	function alert() {
		var pageAll = confirm("EMERGENCY ONLY:\nAre you sure you want to page all on-call doctors?");
                if(pageAll){
                // do stuff
                }
	}
